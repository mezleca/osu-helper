...
export class OsuReader {
    ...
    #readLong(){
        const value = Number(this.buffer.getBigInt64(this.offset, true));
        this.offset += 8;       
        return value;
    }
    ...
    #readString() {
        ...
        const stringData = new Uint8Array(this.buffer.buffer, this.buffer.byteOffset + this.offset, length.value);
